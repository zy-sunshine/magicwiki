 ...
 * @ingroup Skins
 */
class SkinMagic extends SkinTemplate {
  /** Using magic. */
  var $skinname = 'magic', $stylename = 'magic',
    $template = 'MagicTemplate', $useHeadElement = true;
 ...
 * @ingroup Skins
 */
class MagicTemplate extends BaseTemplate {
